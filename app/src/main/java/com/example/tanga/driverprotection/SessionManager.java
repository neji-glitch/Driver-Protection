...
public class SessionManager {
    ...
    public void setLogin(boolean isLoggedIn, User user) {
     ...
     //   editor.putString("social", user.getSocialPlatform());
        ...
        editor.putInt(_context.getResources().getString(R.string.vehicle), user.getVehicle());
    ...
    public boolean getLogin(User user) {
        ...
        {   user.setVehicle(prefs.getInt(_context.getResources().getString(R.string.vehicle), 15));
